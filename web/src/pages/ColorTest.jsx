        ...
        <div className="min-h-screen bg-primary-50 p-8 text-primary-700 font-sans">
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <section className="space-y-6">
                    <h2 className="text-2xl font-bold border-l-4 border-primary-600 pl-4">Color Palette</h2>
                ...
                <section className="space-y-6">
                    <h2 className="text-2xl font-bold border-l-4 border-primary-600 pl-4">Text & Background Checks</h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-primary-600 rounded-3xl p-8 shadow-xl shadow-primary-600/20 text-white space-y-4">
                            <h3 className="text-xl font-black text-primary-600 text-center">Obsidian Background</h3>
                            ...
                            <div className="bg-primary-700 rounded-2xl p-4 border border-white/5 space-y-2">
                                <p className="text-sm text-primary-600 font-mono">Nested Primary-700</p>
                                <div className="text-xs text-white/70">With slightly dimmer text for hierarchy.</div>
                            </div>
                            <button className="w-full bg-primary-600 text-white py-3 rounded-2xl font-bold hover:bg-primary-600/90 transition-colors shadow-lg shadow-primary-600/20">
                                Accent Action
                            </button>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 text-primary-600 border border-slate-100 space-y-4">
                            ...
                            <div className="bg-primary-50 rounded-2xl p-4 border border-primary-600/20 space-y-2">
                                <p className="text-sm text-primary-600 font-mono font-bold">Nested Accent-100</p>
                ...
                <section className="space-y-6">
                    <h2 className="text-2xl font-bold border-l-4 border-primary-600 pl-4">Interactive Elements</h2>
                    <div className="flex flex-wrap gap-4 items-center">
                        ...
                        <button className="px-6 py-3 bg-primary-50 text-primary-600 rounded-full font-bold hover:bg-primary-600 hover:text-white transition-all">
                            Soft Accent
                        </button>
                    </div>
                </section>
